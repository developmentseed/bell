...
internals.Client.prototype.temporary = function (oauth_callback) {
    ...
    return this._request('get', this.settings.temporary, null, oauth, { desc: 'temporary credentials' });
};
...
internals.Client.prototype._request = async function (method, uri, params, oauth, options) {
    ...
    params = oauth
    // TODO: figure out a better way to set the oauth_callback
    params.oauth_callback = 'http://10.0.1.87:8181/login'
